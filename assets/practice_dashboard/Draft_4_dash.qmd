...
format: 
  dashboard:
    nav-buttons: [html]
    html: https://grunwaldlab.github.io/pathogensurveillance_documentation/xanthomonas
    #nav-buttons: [github]
    #github: https://github.com/mine-cetinkaya-rundel/ld-dashboard
    scrolling: true
logo: nf-core-plantpathsurveil_logo.png
theme: united
editor: visual
