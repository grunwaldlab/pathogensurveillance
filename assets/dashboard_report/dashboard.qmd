...
This is a list of issues reported by the pipeline during execution. When relevant, the sample IDs or reference IDs associated with the issue are included.
...
htmltools::HTML('
  ...
  <button type="button" 
    ...
    data-bs-content="Shown are phylogenetic trees of samples with reference sequences meant to provide a reliable identification using genome-scale data.
...
htmltools::HTML('
  ...
  <button type="button" 
    ...
    data-bs-toggle="popover" data-bs-trigger="click focus"
    data-bs-placement="left" data-bs-html="true"
    data-bs-content="This figure depicts a minimium spanning network (MSN).
...
```{r plot_msns, results='asis', eval = ! is.null(align_data) && nrow(align_data) > 0, cache=TRUE}
